...
* 특히, 은행은 화폐 창조 과정에서 다음과 같은 **주요 리스크 및 제약**에 직면한다. 
	* Solvency: 은행의 자본건전성과 관련된 지급능력 리스크.
...
* 좀 더 자세히 알아보자. 
	* 은행의 만기불일치 구조 하에서 민간의 예금인출수요를 감당할 수 없을 때, 좀 더 일반적으로는 필요한 유동성을 적시에 조달하지 못할 때 유동성 위기가 터진다. 이러한 경우는 ① 공포 때문에 발생하는 뱅크런(Diamond and Dybig을 생각하자)이 있으며, 더 중요한 것은 ② 담보제약 때문에 발생하는 유동성 위기이다. 꼭 예금인출이라는 뱅크런 형태가 아니더라도, 은행 간 시장에서도 유동성이 메말라있는데 당장 적격담보자산이 부족해서 중앙은행으로부터의 차입을 할 수 없는 경우에도 위기가 발생하는 것이다.
	* 
